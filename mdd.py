...
if __name__ == "__main__":
    ...
    CreateMDD("ETRIERS_CEDILOG","INPUT/ETRIERS_CEDILOG.xlsx")
    CreateMDD("DISQUES_TAMBOURS_CEDILOG","INPUT/DISQUES_TAMBOURS_CEDILOG.xlsx")
    CreateMDD("POMMIER","INPUT/POMMIER.xlsx")
    CreateMDD("AUTOK","INPUT/AUTOK_v2.xlsx")
    ...
    CreateMDD("ASPOCK","INPUT/ASPOCK.xlsx")        